<%-- 
    Document   : displayEditAddressFormNoAjax
    Created on : Oct 25, 2016, 1:39:53 PM
    Author     : josephrohwer
--%>
    ...
    <body>
        ...
        <div class="container">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="address"
                ...
                <div class="form-group">
                    <label for="edit-address" class="col-md-4 control-label">Street Address:</label>
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="edit-address"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="edit-city"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="edit-state"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="edit-zip"
                                  path="zipCode" placeholder="Zip"/>
                ...
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-8">
                        <button type="submit" id="add-button" class="btn btn-default">Save Address</button>
                    </div>
                </div>
            </sf:form>
        </div>
