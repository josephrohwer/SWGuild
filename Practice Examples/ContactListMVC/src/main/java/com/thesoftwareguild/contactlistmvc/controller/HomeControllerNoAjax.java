...
public class HomeControllerNoAjax {
    ...
    public HomeControllerNoAjax(ContactListDao dao) {
        this.dao = dao;
        //dao.addContact(new Contact("Jane", "Doe", "Microsoft", "999-555-1212", "Jane@Microsoft.com"));
        //dao.addContact(new Contact("Richard", "Roe", "Ubersoft", "666-666-1212", "Rick@ubersoft.com"));
    }
    ...
    public String editContactNoAjax(@Valid @ModelAttribute("contact") Contact c, BindingResult result ) {
