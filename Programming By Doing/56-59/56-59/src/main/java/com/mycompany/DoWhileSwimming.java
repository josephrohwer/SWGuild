...
// 1.) Yes they do.
// 2.) Gallant doesn't swim at all, but Goofus swims for 1 min.
// 3.) Gallant checks the temperature before swimming.
// 4.) Goofus dives right in.
// 5.) A while loop only executes if the condition is met. A do-while
//     loop executes first and then will loop if the condition at the end
//     is met.
// 6.) A while loop is a "pre-test loop" and a do-while loop is a "post-test loop." 
