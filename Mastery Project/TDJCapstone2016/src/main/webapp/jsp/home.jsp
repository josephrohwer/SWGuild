...
<html>
    ...
    <body onload="Javascript:loadRecentPosts()">
        ...
        <div class="container" style="margin-top: 60px">        
            <div class="well well-sm" style="text-align: center">
                <div align="center">
                    <img src="${pageContext.request.contextPath}/img/Fontaines.jpg" id="splash-pic" class="img img-responsive img-rounded">
                </div>
                <br>
                <h2 style="margin:auto">Recent Posts</h2>
                <div id="contentRowsRecent" style="height:100%; width:100%; overflow:visible; overflow-x:hidden;"></div>
            </div>
            <div class='push'></div>
        </div>
